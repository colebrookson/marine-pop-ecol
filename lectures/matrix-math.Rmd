...
If you're trying to display a large matrix (i.e. larger than 11x11 in R), you'll need to change a small setting before your matrix. For example, let's make a matrix of 20x20. 
$$
